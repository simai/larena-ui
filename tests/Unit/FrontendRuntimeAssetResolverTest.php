...
$switched['pair_id'] = 'sf-v5.4.0-rc.1-aaaaaaaa-dd786bba';
$switched['bundle_id'] = 'sf-v5.4.0-rc.1-aaaaaaaa-dd786bba-registry-2c596327-exact-git-tree-v2';
...
assert(FrontendRuntimeLock::fromArray($baseline)->pairId() === 'sf-v5.4.0-rc.1-256b6fce-dd786bba');
