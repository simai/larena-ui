...
$switched['pair_id'] = 'ui-aaaaaaaaaaaa-smart-db547bb87b6b';
$switched['bundle_id'] = 'ui-aaaaaaaaaaaa-smart-db547bb87b6b-registry-184ce743-exact-git-tree-v2';
...
assert(FrontendRuntimeLock::fromArray($baseline)->pairId() === 'ui-2b9aa9635ad0-smart-db547bb87b6b');
